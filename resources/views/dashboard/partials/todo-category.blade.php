...
@endpush
            <div class="mb-4">
                ...
                <div class="flex justify-between items-center mb-4">
                    <select id="categorySelect" class="w-3/4 p-2 border rounded focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                ...
                <div id="categoryList" class="my-2">
                    <!-- List of selected categories will appear here -->
                </div>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 dark:text-white font-bold">Albums:</label>

                <div class="flex justify-between items-center mb-4">
                    <select id="albumSelect" class="w-3/4 p-2 border rounded focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                        @foreach ($albums as $album)
                        <option value="{{ $album->id }}">{{ $album->title }}</option>
                        @endforeach
                    </select>
                    <button type="button" id="addAlbum" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-700 focus:outline-none focus:bg-blue-700 ml-2">Add Album</button>
                </div>
                <div id="albumList" class="my-2">
