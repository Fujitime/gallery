            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        ...
                        <div class="dropdown">
                            <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full">
                                <li>
                                    <a href="#" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Profile</a>
                                </li>
                                <li>
                            ...
                            @foreach($recentAllGalleries as $gallery)
                                <div class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ route('galleries.show', $gallery->id) }}" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">{{ $gallery->title }}</a>
                                    </div>
                                </div>
                            @endforeach
                    </div>
