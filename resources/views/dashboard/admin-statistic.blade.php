   ...
   <div class="p-6">
            ...
            <div class="flex justify-between mb-6">
                <div>
                    <div class="flex items-center mb-1">
                        ...
                        <div class="text-2xl font-semibold">{{ $totalUsers ?? 'Data not available' }}</div>
                    </div>
                    <div class="text-sm font-medium text-gray-400 dark:text-gray-300">Total Users</div>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="flex justify-between mb-4">
                <div>
                    <div class="flex items-center mb-1">
                        ...
                        <div class="text-2xl font-semibold">{{ $totalCategories ?? 'Data not available' }}</div>
                    </div>
                    <div class="text-sm font-medium text-gray-400 dark:text-gray-300">Total Category</div>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="flex justify-between mb-6">
                <div>
                    <div class="flex items-center mb-1">
                        ...
                        <div class="text-2xl font-semibold mb-1">{{$totalAllGalleries ?? 'Data not available'}}</div>
                    </div>
                    <div class="text-sm font-medium text-gray-400 dark:text-gray-300">Total Gallery</div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div class="bg-white dark:bg-gray-800 border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <h3 class="text-gray-700 dark:text-gray-300 font-semibold">Recent Kategori</h3>
                    @forelse ($recentCategories as $category)
                        <p class="text-gray-600 dark:text-gray-400">- {{ $category->name }}</p>
                    @empty
                        <p class="text-gray-600 dark:text-gray-400">Recent Category Not Availavle</p>
                    @endforelse
                </div>
        ...
        <div class="flex flex-wrap items-center px-4 py-2">
            <div class="relative w-full max-w-full flex-grow flex-1">
                <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Users {{ $totalUsers ?? 'Data not available' }}</h3>
            </div>
        </div>
            ...
            <table class="items-center w-full bg-transparent border-collapse">
                ...
                <tbody class="text-gray-700 dark:text-gray-100">
                    <tr>
                        ...
                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ $totalAdmins ?? 'Data not available' }}</td>
                    </tr>
                    <tr>
                        <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">User</th>
                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ $totalRegularUsers ?? 'Data not available' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
        <div class="flex justify-between mb-4 items-start">
            <div class="font-medium">Recent Gallery</div>
        </div>
