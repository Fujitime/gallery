        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @forelse ($galleries as $gallery)
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">{{ $gallery->user->username }}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <a href="{{ route('galleries.show', $gallery->id) }}">
                            ...
                            <svg class="w-6 h-6 text-blue-500"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
